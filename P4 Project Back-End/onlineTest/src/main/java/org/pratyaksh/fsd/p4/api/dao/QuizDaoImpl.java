...
import org.pratyaksh.fsd.p4.api.dto.Quiz;
import org.pratyaksh.fsd.p4.api.dto.User;
import org.pratyaksh.fsd.p4.api.exception.OnlineTestDaoException;
import org.pratyaksh.fsd.p4.api.mapper.CategoryMapper;
import org.pratyaksh.fsd.p4.api.mapper.QuizMapper;
import org.pratyaksh.fsd.p4.api.mapper.UserMapper;
...
public class QuizDaoImpl implements QuizDao {
	...
	public Quiz save(Quiz quiz) throws OnlineTestDaoException {
		...
		try {
			org.pratyaksh.fsd.p4.api.entity.Quiz entity = mapper.toEntity(quiz);
	...
	public byte[] getQuizImage(Long id) throws OnlineTestDaoException {
		...
		try {
			org.pratyaksh.fsd.p4.api.entity.Quiz quiz = repository.findWithImageAttachedById(id);
			image = quiz.getImage();
		} catch (Exception e) {
			throw new OnlineTestDaoException(e.getMessage());
		}
